...
class SetCriterion(nn.Module):
    ...
    def forward(self, outputs, targets):
        ...
        """
        # ipdb.set_trace()
        # outputs = {'pred_logits' : , 'pred_spans' : , 'saliency_scores' : , 'saliency_scores_neg' : , 'video_mask' : }
        # outputs['pred_logits'].shape = [batch size, 10, 2]
        # outputs['pred_spans'].shape =   [batch size, 10, 2]
