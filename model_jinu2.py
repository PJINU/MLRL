...
class QDDETR(nn.Module):
    ...
    def forward(self, src_txt, src_txt_mask, src_vid, src_vid_mask, src_aud=None, src_aud_mask=None, train_type=None):
        ...
        if train_type == 'representation':
            pred_rep, target_block, = self.transformer(src, 
                                                        ~mask, 
        ...
        if train_type == 'mr':
            ...
            _, _, memory_neg, memory_global_neg = self.transformer(src_neg, ~mask_neg, self.query_embed.weight, pos_neg, train_type, video_length=video_length)
