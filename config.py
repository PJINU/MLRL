...
class BaseOptions(object):
    ...
    def initialize(self):
        ...
        parser.add_argument("--device_num", type=int, default=0, help="num of gpu to use")
        ...
        parser.add_argument("--lr_rep", type=float, default=1e-5, help="learning rate")
        parser.add_argument("--lr_drop_rep", type=int, default=50, help="drop learning rate to 1/10 every lr_drop epochs")
        parser.add_argument("--wd_rep", type=float, default=0.01, help="weight decay")
        
        parser.add_argument("--n_epoch", type=int, default=200, help="number of epochs to run")
        parser.add_argument("--n_epoch_rep", type=int, default=100, help="number of representation learning epochs to run")
        ...
        parser.add_argument("--bsz_rep", type=int, default=128, help="mini-batch size for representation learning")
        parser.add_argument("--eval_bsz", type=int, default=100,
                            help="mini-batch size at inference, for query")
        parser.add_argument("--eval_bsz_rep", type=int, default=100,
                            help="mini-batch size at inference, for query")
